...
vim.keymap.set('n', '<F3>', '<cmd>nohlsearch<CR>', { noremap = true, silent = true })
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>st', ':TodoTelescope<CR>', { desc = '[s]earch [s]elect telescope' })
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      -- Enable autoformat based on filetype
      -- format_on_save = function(bufnr)
